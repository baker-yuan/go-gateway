...
func (n *node) addRoute(path string, handle *ServiceInfo) {
	fullPath := path
	n.priority++
...
func (n *node) insertChild(numParams uint8, path, fullPath string, handle *ServiceInfo) {
...
// given path.
func (n *node) getValue(path string) (handle *ServiceInfo, p Params, tsr bool) {
