...
import (
	...
	eocontext "github.com/baker-yuan/go-gateway/pkg/context"
...
// @scheme 请求http协议
// @node 下游服务节点信息
func ProxyTimeout(scheme string, node eocontext.IInstance, req *fasthttp.Request, resp *fasthttp.Response, timeout time.Duration) error {
